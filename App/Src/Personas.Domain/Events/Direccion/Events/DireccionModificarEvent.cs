...
{
    public class DireccionModificarEvent : Event
    {
        public DireccionModificarEvent(Guid id, Guid idPersona, string calle, string numero, string numeroCasaDepartamento, string comuna)
        {
            Id = id;
            IdPersona = idPersona;
            Calle = calle;
